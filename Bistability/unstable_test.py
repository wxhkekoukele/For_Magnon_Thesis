...
power,delta,wd,a_s,m_s=Bistability_with_K_evo(**para).Unstable_array_with_as_and_ms()
power2,delta2,wd2,a_s2,m_s2=Bistability_with_K_evo(**para).BS_array_with_as_and_ms(start_energy='higher')
...
axes1.plot(power1,delta1, 'o', linewidth=5,color='blue',markersize=10,label=r'forward')

axes1.plot(power2,delta2, 'o', linewidth=5,color='green',markersize=10,label=r'forward')
